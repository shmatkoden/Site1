...
router.post('/api/process-payment', async (req, res) => {
    const { totalAmount, playerId } = req.body; // Получаем итоговую сумму и ID игрока из тела запроса
    const currency = 'RUB'; // Фиксируем валюту как рубли
